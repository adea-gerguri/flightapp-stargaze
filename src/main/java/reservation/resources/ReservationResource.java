...
public class ReservationResource {
  ...
  public Uni<List<ReservationEntity>> listReservations(
      @BeanParam PaginationQueryParams paginationQueryParams) {
  ...
  public Uni<ReservationDto> findByUserIdAndFlightNumber(
      @QueryParam("userId") String userId, @QueryParam("flightNumber") String flightNumber) {
  ...
  public Uni<List<ReservationRevenueDto>> salesOverTime(
      @BeanParam RevenueQueryParams revenueQueryParams) {
  ...
  public Uni<List<ReservationRevenueDto>> facetedRevenue(
      @BeanParam RevenueQueryParams revenueQueryParams) {
  ...
  public Uni<List<RevenueAggregationDto>> revenueOverTimePeriods(
      @BeanParam RevenueQueryParams revenueQueryParams) {
